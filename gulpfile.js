...
gulp.task('replaceFiles', () => {
  let imgs = gulp.src(path.imgSrc, {since: gulp.lastRun('replaceFiles')}).pipe(gulp.dest('build/img/')),
      fonts = gulp.src(path.fontSrc, {since: gulp.lastRun('replaceFiles')}).pipe(gulp.dest('build/fonts/')),
      fav = gulp.src('app/favicon.ico/*.*', {since: gulp.lastRun('replaceFiles')}).pipe(gulp.dest('build/favicon.ico/')),
      php = gulp.src(path.phpSrc).pipe(gulp.dest('build/php/'));
...
gulp.task('watch', () => {
  ...
  gulp.watch([path.imgSrc, path.fontSrc, path.phpSrc], gulp.series('replaceFiles'));
});
